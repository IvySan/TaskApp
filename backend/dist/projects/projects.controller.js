...
let ProjectsController = class ProjectsController {
    ...
    addProjectToUser(id, data) {
        return this.projectsService.addProjectToUser(+id, data);
    }
    removeProjectFromUser(id, data) {
...
__decorate([
    (0, common_1.Get)(':userId/getProjectsForUser'),
...
__decorate([
    (0, common_1.Post)(':id/addProject'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], ProjectsController.prototype, "addProjectToUser", null);
__decorate([
    (0, common_1.Delete)(':id/removeProject'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], ProjectsController.prototype, "removeProjectFromUser", null);
